...
function newsDetail() {
  ...
  var template = "\n    <div class=\"bg-gray-600 min-h-screen pb-8\">\n      <div class=\"bg-white text-xl fixed top-0 left-0 right-0\">\n        <div class=\"mx-auto px-4\">\n          <div class=\"flex justify-between items-center py-6\">\n            <div class=\"flex justify-start\">\n              <h1 class=\"font-extrabold\">Hacker News</h1>\n            </div>\n            <div class=\"items-center justify-end\">\n              <a href=\"#/page/".concat(store.currentPage, "\" class=\"text-gray-500\">\n                <i class=\"fa fa-times\"></i>\n              </a>\n            </div>\n          </div>\n        </div>\n      </div>\n      <div class=\"pt-20\">\n        <div class=\"h-full border rounded-xl bg-white m-6 p-6\">\n          <h2 class=\"mb-4 text-xl font-bold\">").concat(newsContent.title, "</h2>\n          <div class=\"flex justify-start mb-4 text-sm text-gray-500 \">\n            <div class=\"mr-4\"><i class=\"fas fa-user mr-1\"></i>").concat(newsContent.user, "</div>\n            <div class=\"mr-4\"><i class=\"fas fa-heart mr-1\"></i>").concat(newsContent.points, "</div>\n            <div class=\"mr-4\"><i class=\"far fa-clock mr-1\"></i>").concat(newsContent.time_ago, "</div>\n          </div>\n          <div class=\"text-gray-400 h-10\">\n            <iframe type=\"html\" src=\"").concat(newsContent.url, "\" class=\"w-full border rounded-xl shadow-md overflow-hidden\" height=\"500px\">\n              This browser does not support iframe tag. \n              Please click this <a href=\"").concat(newsContent.url, "\" class=\"underline text-green-400\">URL</a> to check the content.\n            </iframe>\n          </div>\n          \n          <div style=\"margin-top: 500px;\">\n          <h3 class=\"text-l font-bold\">Comments <span class=\"text-green-400\">(").concat(newsContent.comments_count, ")</span></h3>\n\n            {{__comments__}}\n\n          </div>\n        </div>\n      </div>\n    </div>\n  ");
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "2595" + '/');
